...
title: '2024-09-07 PostgreSQLの便利クエリの動作確認①'
pubDate: 2024-09-07
...
concurentlyなインデックスの作成進捗の確認（巨大なテーブルにで使用)
```sql
...
インデックス スキャンよりもシーケンススキャンの方が多いかどうかをチェックします。テーブルが小さい場合は、Postgres がシーケンス スキャンを優先するため、無視されます。
